...
import sn.ondmoney.history.security.*;
import sn.ondmoney.history.security.AuthoritiesConstants;
import sn.ondmoney.history.security.SecurityUtils;
import sn.ondmoney.history.security.oauth2.AudienceValidator;
import java.util.*;
